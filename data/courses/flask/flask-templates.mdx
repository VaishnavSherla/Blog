...
date: '2023-12-06'
summary: Learn about Flask templates with Vaishnav Sherla. Explore the basics of using templates in Flask for web development.
draft: false
authors: ['default']
---
...
```
![Desktop View](/static/courses/flask/flaskTemplates/01.png)
...
```
![Desktop View](/static/courses/flask/flaskTemplates/02.png)
_Output of Above Code._
...
if __name__ == '__main__':
    app.run(debug=True)
```
![Desktop View](/static/courses/flask/flaskTemplates/03.png)
_Output of About Us Page._
![Desktop View](/static/courses/flask/flaskTemplates/04.png)
...
{% endblock %}
```
![Desktop View](/static/courses/flask/flaskTemplates/05.png)
...
```
![Desktop View](/static/courses/flask/flaskTemplates/06.png)
