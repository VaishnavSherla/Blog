...
date: '2023-12-23'
summary: Explore advanced forms using WTForms with Vaishnav Sherla. Learn how to handle forms securely and validate user input in Flask. Learn about CSRF protection and Attack.
draft: false
authors: ['default']
---
...
![Desktop View](/static/courses/flask/advForms/Form.png)
_Form Rendering._

![Desktop View](/static/courses/flask/advForms/Dashboard.png)
_DashBoard After Form Submission._

![Desktop View](/static/courses/flask/advForms/FlashMsg.png)
_Flash Msg._

![Desktop View](/static/courses/flask/advForms/PostReq.png)
_Post Req with CSRF Token._

![Desktop View](/static/courses/flask/advForms/SessionStorage.png)
